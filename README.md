...
Payment Gateway API for payment processing. Version 1.15.0
...
```groovy
compile "com.github.GBSEcom.client:first-data-gateway:1.15.0"
```
...
* `target/first-data-gateway-1.15.0.jar`
* `build/libs/*.jar`
