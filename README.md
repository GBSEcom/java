...
Payment Gateway API for payment processing. Version 1.12.2
...
```groovy
compile "com.github.GBSEcom.client:first-data-gateway:1.12.2"
```
...
* `target/first-data-gateway-1.12.2.jar`
* `build/libs/*.jar`
