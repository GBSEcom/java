...
Payment Gateway API for payment processing. Version 1.12.1
...
```groovy
compile "com.github.GBSEcom.client:first-data-gateway:1.12.1"
```
...
* `target/first-data-gateway-1.12.1.jar`
* `build/libs/*.jar`
