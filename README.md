...
Payment Gateway API for payment processing. Version 1.12.0
...
```groovy
compile "com.github.GBSEcom.client:first-data-gateway:1.12.0"
```
...
* `target/first-data-gateway-1.12.0.jar`
* `build/libs/*.jar`
