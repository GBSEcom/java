...
Payment Gateway API for payment processing. Version 1.14.0
...
```groovy
compile "com.github.GBSEcom.client:first-data-gateway:1.14.0"
```
...
* `target/first-data-gateway-1.14.0.jar`
* `build/libs/*.jar`
