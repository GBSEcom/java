        ...
        GsonFireBuilder fireBuilder = new GsonFireBuilder()
                ...
                .registerTypeSelector(AuthenticationUpdateRequest.class, new TypeSelector() {
                    ...
                    public Class getClassForElement(JsonElement readElement) {
                        ...
                        classByDiscriminatorValue.put("Secure3DAuthenticationUpdateRequest".toUpperCase(Locale.ROOT), Secure3DAuthenticationUpdateRequest.class);
                ...
                .registerTypeSelector(ManagedRedirectPrimaryRequest.class, new TypeSelector() {
                    @Override
                    public Class getClassForElement(JsonElement readElement) {
                        Map classByDiscriminatorValue = new HashMap();
                        classByDiscriminatorValue.put("PaymentCardManagedRedirectRequest".toUpperCase(Locale.ROOT), PaymentCardManagedRedirectRequest.class);
                        classByDiscriminatorValue.put("GenericManagedRedirectRequest".toUpperCase(Locale.ROOT), GenericManagedRedirectRequest.class);
                        classByDiscriminatorValue.put("ManagedRedirectPrimaryRequest".toUpperCase(Locale.ROOT), ManagedRedirectPrimaryRequest.class);
                        return getClassByDiscriminator(classByDiscriminatorValue,
                                getDiscriminatorValue(readElement, "requestType"));
                    }
          })
                ...
                .registerTypeSelector(PrimaryTransaction.class, new TypeSelector() {
                    ...
                    public Class getClassForElement(JsonElement readElement) {
                        ...
                        classByDiscriminatorValue.put("ApmSaleTransaction".toUpperCase(Locale.ROOT), ApmSaleTransaction.class);
                        ...
                        classByDiscriminatorValue.put("SepaCreditTransaction".toUpperCase(Locale.ROOT), SepaCreditTransaction.class);
                ...
                .registerTypeSelector(SecondaryTransaction.class, new TypeSelector() {
                    ...
                    public Class getClassForElement(JsonElement readElement) {
                        ...
                        classByDiscriminatorValue.put("PreAuthSecondaryTransaction".toUpperCase(Locale.ROOT), PreAuthSecondaryTransaction.class);
                        classByDiscriminatorValue.put("SecondaryTransaction".toUpperCase(Locale.ROOT), SecondaryTransaction.class);
                        return getClassByDiscriminator(classByDiscriminatorValue,
                                getDiscriminatorValue(readElement, "requestType"));
                    }
          })
                .registerTypeSelector(StepRequest.class, new TypeSelector() {
                    @Override
                    public Class getClassForElement(JsonElement readElement) {
                        Map classByDiscriminatorValue = new HashMap();
                        classByDiscriminatorValue.put("provide-detail".toUpperCase(Locale.ROOT), ProvideDetailPaymentStepRequest.class);
                        classByDiscriminatorValue.put("StepRequest".toUpperCase(Locale.ROOT), StepRequest.class);
                        return getClassByDiscriminator(classByDiscriminatorValue,
                                getDiscriminatorValue(readElement, "type"));
                    }
          })
                .registerTypeSelector(StepResponse.class, new TypeSelector() {
                    @Override
                    public Class getClassForElement(JsonElement readElement) {
                        Map classByDiscriminatorValue = new HashMap();
                        classByDiscriminatorValue.put("provide-detail".toUpperCase(Locale.ROOT), ProvideDetailPaymentStepResponse.class);
                        classByDiscriminatorValue.put("StepResponse".toUpperCase(Locale.ROOT), StepResponse.class);
                        return getClassByDiscriminator(classByDiscriminatorValue,
                                getDiscriminatorValue(readElement, "type"));
                    }
          })
