 ...
 */
@ApiModel(description = "Various wallet payment methods the gateway supports. Abstract class, do not use this class directly, use one of its children: EncryptedGooglePayWalletPaymentMethod, EncryptedApplePayWalletPaymentMethod, EncryptedSamsungPayWalletPaymentMethod.")
