...
public class MerchantLocation {
   ...
   * @return locationId
  **/
  @ApiModelProperty(value = "The unique ID of this location.")
  ...
  **/
   ...
   * @return hierarchy
  **/
  @ApiModelProperty(value = "Free-text field to describe a hierarchy the merchant would like to provide.")
  ...
  **/
   ...
   * @return userDefined
  **/
  @ApiModelProperty(value = "A JSON object that can carry any additional information about the location that might be helpful for fraud detection.")
