...
public class Receipt {
  ...
  private List<ReceiptLine> data = new ArrayList<>();
  ...
  **/
  ...
  public Receipt data(List<ReceiptLine> data) {
  ...
  **/
  ...
  public List<ReceiptLine> getData() {
    return data;
  }



  public void setData(List<ReceiptLine> data) {
    this.data = data;
  }
