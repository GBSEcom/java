...
public class TransactionResponse extends BasicResponse {
  ...
  private Object authenticationRedirect = null;
  ...
  **/
  ...
  public TransactionResponse paymentToken(PaymentTokenization paymentToken) {
  ...
  **/
  ...
  public TransactionResponse paymentMethod(PaymentMethod paymentMethod) {
  ...
  **/
  ...
  public TransactionResponse authenticationRedirect(Object authenticationRedirect) {
  ...
  **/
  @ApiModelProperty(value = "")
  public Object getAuthenticationRedirect() {
    return authenticationRedirect;
  }

  public void setAuthenticationRedirect(Object authenticationRedirect) {
    this.authenticationRedirect = authenticationRedirect;
  }
  ...
  **/
  @ApiModelProperty(value = "The transaction ID received from schemes for the initial transaction of card on file flows.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ipgTransactionId, orderId, transactionType, paymentToken, transactionOrigin, paymentMethod, country, terminalId, merchantTransactionId, transactionTime, approvedAmount, transactionStatus, transactionState, secure3dResponse, redirectURL, authenticationRedirect, schemeTransactionId, processor, additionalDetails, super.hashCode());
  }
