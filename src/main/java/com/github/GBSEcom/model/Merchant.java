...
import com.github.GBSEcom.model.MerchantLocation;
...
public class Merchant {
  ...
  **/
  ...
  public Merchant location(MerchantLocation location) {
  ...
  **/
   ...
   * @return userDefined
  **/
  @ApiModelProperty(value = "A JSON object that can carry any additional information about the merchant that might be helpful for fraud detection.")
