...
import com.github.GBSEcom.model.DeviceNetworks;
...
public class Device {
  ...
  private List<DeviceNetworks> networks = null;
  ...
  **/
  ...
  public Device networks(List<DeviceNetworks> networks) {
    this.networks = networks;
    return this;
  }

  public Device addNetworksItem(DeviceNetworks networksItem) {
  ...
  **/
  ...
  public List<DeviceNetworks> getNetworks() {
    return networks;
  }

  public void setNetworks(List<DeviceNetworks> networks) {
    this.networks = networks;
  }
  ...
  **/
   ...
   * @return imei
  **/
  @ApiModelProperty(example = "49-015420-323751", value = "The device's International Mobile Equipment Identity (IMEI) as described in IETFs RFC7254.")
  ...
  **/
   ...
   * @return userDefined
  **/
  @ApiModelProperty(value = "A JSON object that can carry any additional information about the device that might be helpful for fraud detection.")
