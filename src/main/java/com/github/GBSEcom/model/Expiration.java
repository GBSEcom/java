...
public class Expiration {
   ...
   * @return month
  **/
  @ApiModelProperty(example = "03", required = true, value = "Month of the card expiration date.")
   ...
   * @return year
  **/
  @ApiModelProperty(example = "21", required = true, value = "Year of the card expiration date.")
