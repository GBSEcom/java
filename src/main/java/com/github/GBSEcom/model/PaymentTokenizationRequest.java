...
public class PaymentTokenizationRequest {
  ...
  **/
  @ApiModelProperty(value = "If the account should be verified prior to token creation.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(requestType, storeId, billingAddress, createToken, accountVerification);
  }
