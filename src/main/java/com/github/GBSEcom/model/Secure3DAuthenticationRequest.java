...
public class Secure3DAuthenticationRequest extends AuthenticationRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(termURL, methodNotificationURL, challengeIndicator, messageCategory, challengeWindowSize, browserJavaScriptEnabled, requestorAuthenticationIndicator, super.hashCode());
  }
