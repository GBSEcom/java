...
import com.github.GBSEcom.model.PaymentIssuerResponse;
import com.github.GBSEcom.model.PaymentPayMethod;
import com.github.GBSEcom.model.PaymentVerification3ds;
import com.github.GBSEcom.model.PaymentVerificationAvs;
import com.github.GBSEcom.model.PaymentVerificationCvv;
...
public class Payment {
  ...
  private PaymentPayMethod payMethod = null;
  ...
  public enum EntryMethodEnum {
    ...
    public static class Adapter extends TypeAdapter<EntryMethodEnum> {
      ...
      public EntryMethodEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return EntryMethodEnum.fromValue(String.valueOf(value));
      }
    }
  }
  ...
  private PaymentIssuerResponse issuerResponse = null;
  ...
  private PaymentVerificationCvv verificationCvv = null;
  ...
  **/
  ...
  public Payment payMethod(PaymentPayMethod payMethod) {
  ...
  **/
  ...
  public PaymentPayMethod getPayMethod() {
    return payMethod;
  }

  public void setPayMethod(PaymentPayMethod payMethod) {
    this.payMethod = payMethod;
  }
  ...
  **/
  ...
  public Payment issuerResponse(PaymentIssuerResponse issuerResponse) {
  ...
  **/
  ...
  public PaymentIssuerResponse getIssuerResponse() {
    return issuerResponse;
  }

  public void setIssuerResponse(PaymentIssuerResponse issuerResponse) {
    this.issuerResponse = issuerResponse;
  }
  ...
  **/
  @ApiModelProperty(value = "The actual approved amount. This field should be filled in when the message has already passed through the issuer (e.g. post-authorization). For transaction/authorization this amount refers to the amount that was locked on the card-holders account.")
  ...
  **/
  @ApiModelProperty(value = "The payment methods account balance if available. This field should be filled in when the message has already passed through the issuer (e.g. post-authorization).")
  ...
  public Payment verificationAvs(PaymentVerificationAvs verificationAvs) {
  ...
  **/
  @ApiModelProperty(value = "")
  public PaymentVerificationAvs getVerificationAvs() {
    return verificationAvs;
  }

  public void setVerificationAvs(PaymentVerificationAvs verificationAvs) {
    this.verificationAvs = verificationAvs;
  }

  public Payment verification3ds(PaymentVerification3ds verification3ds) {
  ...
  **/
  @ApiModelProperty(value = "")
  public PaymentVerification3ds getVerification3ds() {
    return verification3ds;
  }

  public void setVerification3ds(PaymentVerification3ds verification3ds) {
    this.verification3ds = verification3ds;
  }

  public Payment verificationCvv(PaymentVerificationCvv verificationCvv) {
  ...
  **/
  @ApiModelProperty(value = "")
  public PaymentVerificationCvv getVerificationCvv() {
    return verificationCvv;
  }

  public void setVerificationCvv(PaymentVerificationCvv verificationCvv) {
    this.verificationCvv = verificationCvv;
  }
   ...
   * @return userDefined
  **/
  @ApiModelProperty(value = "A JSON object that carries any additional information that might be helpful for fraud detection.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.paymentType, payment.paymentType) &&
        Objects.equals(this.payMethod, payment.payMethod) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(paymentType, payMethod, pinPresent, entryMethod, issuerResponse, issuerApprovedAmount, issuerCardBalance, verificationAvs, verification3ds, verificationCvv, userDefined);
  }
