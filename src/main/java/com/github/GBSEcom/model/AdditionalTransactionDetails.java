...
public class AdditionalTransactionDetails {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[{\"type\":\"cardholder\",\"data\":[\" SALE \",\"------\"]},{\"type\":\"merchant\",\"data\":[\"Example Merchant\",\"---------------\",\"   Amount: 54 EURO   \"]}]", value = "Provides receipt response data, if it has been requested.")
