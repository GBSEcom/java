 ...
 */
@ApiModel(description = "Request authentication of the payment card using the 3DS URL redirect scheme.")

public class Secure3dAuthenticationRequest extends Authentication {
