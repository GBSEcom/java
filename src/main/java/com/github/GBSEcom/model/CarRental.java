...
public class CarRental {
  ...
  **/
  @ApiModelProperty(value = "The car rental agreement number")
   ...
   * @return renterName
  **/
  @ApiModelProperty(value = "The name of the person renting the car")
   ...
   * @return returnCity
  **/
  @ApiModelProperty(value = "The name of the city where the rental ends and the car is returned")
  ...
  **/
  @ApiModelProperty(value = "The classification of the rental car")
   ...
   * @return extraCharges
  **/
  @ApiModelProperty(value = "Array containing information about charges other than the rental rate.")
