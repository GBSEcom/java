...
public class Card {
   ...
   * @return taToken
  **/
  @ApiModelProperty(value = "TransArmor Token value. Either the ta token fields or card number field must contain a value.")
   ...
   * @return taTokenKey
  **/
  @ApiModelProperty(value = "TransArmor Token Key to identify the merchant.")
  ...
  **/
   ...
   * @return cardNumber
  **/
  @ApiModelProperty(value = "Use this field to send Clear PAN or tokens other than TransArmor Token.")
   ...
   * @return expDate
  **/
  @ApiModelProperty(value = "Payment method expiration date. Format is MMCCYY.")
   ...
   * @return cvv
  **/
  @ApiModelProperty(value = "CVV Present indicator.")
