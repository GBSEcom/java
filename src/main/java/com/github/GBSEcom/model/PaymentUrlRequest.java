...
public class PaymentUrlRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(storeId, clientLocale, transactionAmount, transactionType, orderId, billing, shipping, transactionNotificationURL, expiration, authenticateTransaction, dynamicMerchantName, invoiceNumber, purchaseOrderNumber, hostedPaymentPageText, ip, revolvingOptions);
  }
