...
public class PaymentUrlRequest {
  ...
  **/
  @ApiModelProperty(example = "https://showmethepaymentresult.com", value = "URL for notifying merchant with payment result.")
   ...
   * @return expiration
  **/
  @ApiModelProperty(example = "1518811817", value = "Time until payment URL expires.")
  ...
  **/
  @ApiModelProperty(value = "If 3D secure should be applied.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(storeId, clientLocale, amount, transactionType, orderId, billing, shipping, transactionNotificationURL, expiration, authenticateTransaction, dynamicMerchantName, invoiceNumber, purchaseOrderNumber, ip);
  }
