 ...
 */
@ApiModel(description = "Response for Managed redirect transaction request")

public class ManagedRedirectResponse {
  ...
  public ManagedRedirectResponse clientRequestId(String clientRequestId) {
  ...
  **/
  ...
  public ManagedRedirectResponse apiTraceId(String apiTraceId) {
  ...
  **/
  ...
  public ManagedRedirectResponse responseType(ResponseType responseType) {
  ...
  **/
  ...
  public ManagedRedirectResponse requestStatus(RequestStatusEnum requestStatus) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "SUCCESS", value = "The status of the request.")
  ...
  public ManagedRedirectResponse orderId(String orderId) {
  ...
  **/
  ...
  public ManagedRedirectResponse redirectURL(String redirectURL) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "https://api.firstdata.com/connect/gateway/processing?storename=123456789&oid=R-96cdbaa4-c22e-4598-a2f1-c2b5fed79ef1&redirectRequestId=d3eb74fe-cf63-47e1-b89f-52ba0cc7965c", value = "URL for embedded payment link.")
  ...
  public ManagedRedirectResponse transactionId(String transactionId) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ManagedRedirectResponse managedRedirectResponse = (ManagedRedirectResponse) o;
    return Objects.equals(this.clientRequestId, managedRedirectResponse.clientRequestId) &&
        Objects.equals(this.apiTraceId, managedRedirectResponse.apiTraceId) &&
        Objects.equals(this.responseType, managedRedirectResponse.responseType) &&
        Objects.equals(this.requestStatus, managedRedirectResponse.requestStatus) &&
        Objects.equals(this.orderId, managedRedirectResponse.orderId) &&
        Objects.equals(this.redirectURL, managedRedirectResponse.redirectURL) &&
        Objects.equals(this.transactionId, managedRedirectResponse.transactionId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientRequestId, apiTraceId, responseType, requestStatus, orderId, redirectURL, transactionId);
  }
