...
import com.github.GBSEcom.model.PaymentDeviceSaleTransactionAllOf;
 ...
 */
@ApiModel(description = "Request to create sale transaction using decrypted card details from payment device. The transaction origin will be fixed as PHONE when data is manually entered into the device and as RETAIL when data is entered into the device via swipe.")

public class PaymentDeviceSaleTransaction extends PrimaryTransaction {
  ...
  public PaymentDeviceSaleTransaction paymentMethod(PaymentDevicePaymentMethod paymentMethod) {
  ...
  **/
  ...
  public PaymentDeviceSaleTransaction createToken(CreatePaymentToken createToken) {
  ...
  **/
  ...
  public PaymentDeviceSaleTransaction storedCredentials(StoredCredential storedCredentials) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaymentDeviceSaleTransaction paymentDeviceSaleTransaction = (PaymentDeviceSaleTransaction) o;
    return Objects.equals(this.paymentMethod, paymentDeviceSaleTransaction.paymentMethod) &&
        Objects.equals(this.createToken, paymentDeviceSaleTransaction.createToken) &&
        Objects.equals(this.storedCredentials, paymentDeviceSaleTransaction.storedCredentials) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(paymentMethod, createToken, storedCredentials, super.hashCode());
  }
