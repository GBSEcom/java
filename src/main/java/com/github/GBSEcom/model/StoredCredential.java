...
public class StoredCredential {
  ...
  **/
   ...
   * @return scheduled
  **/
  @ApiModelProperty(required = true, value = "Indicates if the transaction is scheduled or part of an installment.")
  ...
  **/
  @ApiModelProperty(example = "019087868716215", value = "The transaction ID received from schemes for the initial transaction. Required if sequence is 'SUBSEQUENT'.")
