...
public class Lodging {
   ...
   * @return arrivalDate
  **/
  @ApiModelProperty(value = "Date of arrival")
  ...
  **/
   ...
   * @return extraCharges
  **/
  @ApiModelProperty(value = "Information about charges other than base lodging")
  ...
  **/
  @ApiModelProperty(value = "Indicates if the transaction is associated with a delayed or no-show penalty")
