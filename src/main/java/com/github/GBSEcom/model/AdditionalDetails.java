...
public class AdditionalDetails {
  ...
  **/
  @ApiModelProperty(value = "Indicates if the particular transaction is a deferred authorization.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(comments, invoiceNumber, purchaseOrderNumber, operatorId, salesSystemId, ipgDeferredAuth);
  }
