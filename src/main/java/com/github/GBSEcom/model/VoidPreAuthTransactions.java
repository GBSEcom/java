 ...
 */
@ApiModel(description = "Request to perform a void of all authorizations associated with the current order. This request type is applicable for voiding preauth and incremental preauth transactions.")

public class VoidPreAuthTransactions extends SecondaryTransaction {
