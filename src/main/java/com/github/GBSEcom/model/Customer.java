 ...
 */
@ApiModel(description = "Customer object, if a customer is registered at the merchants website.")
...
public class Customer {
  ...
  **/
   ...
   * @return startDate
  **/
  @ApiModelProperty(example = "2017-01-04", value = "The timestamp of the customers registration in the merchants platform. Format is CCYY-MM-DD.")
   ...
   * @return firstName
  **/
  @ApiModelProperty(example = "John", value = "Customers first name.")
   ...
   * @return lastName
  **/
  @ApiModelProperty(example = "Smith", value = "Customers last name.")
   ...
   * @return middleName
  **/
  @ApiModelProperty(example = "Joseph", value = "Customers middle name.")
   ...
   * @return email
  **/
  @ApiModelProperty(example = "accept@xyz.com", value = "Customers email address.")
  ...
  **/
   ...
   * @return dateOfBirth
  **/
  @ApiModelProperty(example = "1982", value = "The customers year of birth. Format is CCYY.")
  ...
  **/
   ...
   * @return userDefined
  **/
  @ApiModelProperty(value = "A JSON object that can carry any additional information about the customer that might be helpful for fraud detection.")
