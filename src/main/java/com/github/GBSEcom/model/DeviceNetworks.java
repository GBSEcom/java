...
public class DeviceNetworks {
  ...
  **/
  @ApiModelProperty(example = "12345", value = "The Location Area Code (LAC) is a16-bit identifier for a region that is covered by a set of network antennas.")
  ...
  **/
   ...
   * @return userDefined
  **/
  @ApiModelProperty(value = "A JSON object that can carry any additional information about the network that might be helpful for fraud detection.")
