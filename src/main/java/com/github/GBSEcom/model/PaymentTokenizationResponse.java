...
public class PaymentTokenizationResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientRequestId, apiTraceId, responseType, requestStatus, requestTime, brand, country, paymentToken, paymentCard, processor, orderId, ipgTransactionId, merchantTransactionId);
  }
