...
import com.github.GBSEcom.model.PaymentCardVerificationRequestAllOf;
 ...
 */
@ApiModel(description = "Used to request account verification using a payment card. The expiryDate in paymentCard object is required to perform a PaymentCardVerificationRequest.")

public class PaymentCardVerificationRequest extends AccountVerificationRequest {
  public static final String SERIALIZED_NAME_PAYMENT_CARD = "paymentCard";
  @SerializedName(SERIALIZED_NAME_PAYMENT_CARD)
  private PaymentCard paymentCard;


  public PaymentCardVerificationRequest paymentCard(PaymentCard paymentCard) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaymentCardVerificationRequest paymentCardVerificationRequest = (PaymentCardVerificationRequest) o;
    return Objects.equals(this.paymentCard, paymentCardVerificationRequest.paymentCard) &&
        super.equals(o);
  }
