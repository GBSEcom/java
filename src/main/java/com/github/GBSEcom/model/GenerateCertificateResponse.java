...
public class GenerateCertificateResponse {
  ...
  public GenerateCertificateResponse clientRequestId(String clientRequestId) {
  ...
  **/
  ...
  public GenerateCertificateResponse apiTraceId(String apiTraceId) {
  ...
  **/
  ...
  public GenerateCertificateResponse responseType(ResponseType responseType) {
  ...
  **/
  ...
  public GenerateCertificateResponse zipFile(String zipFile) {
   ...
   * @return zipFile
  **/
  @ApiModelProperty(example = "dGhpcyBpcyBhbiBleGFtcGxlIHdoZXJlIGNlcnRpZmljYXRlIG11c3QgYmU=", required = true, value = "Zip file containing new private key and signed certificate in PKCS#12 and JKS format, encoded in Base64.")
  ...
  public GenerateCertificateResponse privateKeyPassword(String privateKeyPassword) {
  ...
  **/
  @ApiModelProperty(example = "kb$w@4YcV", required = true, value = "Password for PKCS#12 / Private Key Password.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.clientRequestId, generateCertificateResponse.clientRequestId) &&
        Objects.equals(this.apiTraceId, generateCertificateResponse.apiTraceId) &&
        Objects.equals(this.responseType, generateCertificateResponse.responseType) &&
        Objects.equals(this.zipFile, generateCertificateResponse.zipFile) &&
        Objects.equals(this.privateKeyPassword, generateCertificateResponse.privateKeyPassword);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientRequestId, apiTraceId, responseType, zipFile, privateKeyPassword);
  }
