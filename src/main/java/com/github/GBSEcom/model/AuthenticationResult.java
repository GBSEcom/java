...
public class AuthenticationResult {
  ...
  **/
  @ApiModelProperty(example = "Secure3DAuthenticationResult", required = true, value = "Specifies the version of 3DS to be used where authentication was managed outside of the gateway.")
