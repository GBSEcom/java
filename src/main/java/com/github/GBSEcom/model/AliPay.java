...
public class AliPay {
  ...
  **/
  @ApiModelProperty(required = true, value = "Use this to indicate the type of machine-readable payment data for scanning.")
  ...
  **/
   ...
   * @return orderTitle
  **/
  @ApiModelProperty(required = true, value = "Use this to send an order title that shows up in the statement")
   ...
   * @return orderDetails
  **/
  @ApiModelProperty(required = true, value = "Use this to send order details that show up in the statement")
