...
public class CardInfo {
  ...
  private CardFunctionEnum cardFunction;
  ...
  **/
  ...
  public CardInfo cardFunction(CardFunctionEnum cardFunction) {
   ...
   * @return cardFunction
  **/
  @ApiModelProperty(example = "credit", value = "The functions of the card. Possible values are credit, debit, prepaid, voucher and undefined.")
