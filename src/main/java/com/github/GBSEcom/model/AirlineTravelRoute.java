 ...
 */
@ApiModel(description = "Object holding additional information about the route")
...
public class AirlineTravelRoute {
  ...
  **/
   ...
   * @return origin
  **/
  @ApiModelProperty(value = "The IATA code for the departure airport.")
   ...
   * @return destination
  **/
  @ApiModelProperty(value = "The IATA code for the destination airport.")
   ...
   * @return carrierCode
  **/
  @ApiModelProperty(value = "The IATA code for the carrier.")
   ...
   * @return serviceClass
  **/
  @ApiModelProperty(value = "The airline code for the service class of the ticket.")
   ...
   * @return stopoverType
  **/
  @ApiModelProperty(value = "Indicates whether the route is direct or not.")
  ...
  **/
  @ApiModelProperty(value = "The airline fare basis code.")
  ...
  **/
   ...
   * @return flightNumber
  **/
  @ApiModelProperty(value = "The airline flight number associated with the ticket.")
