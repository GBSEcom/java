...
public class ScoreOnlyResponse {
   ...
   * @return apiTraceId
  **/
  @ApiModelProperty(value = "Unique trace ID for issue triage")
  ...
  **/
  @ApiModelProperty(value = "Please refer to \"Errors Section\" for more info.")
  ...
  **/
  @ApiModelProperty(value = "If status returned is \"failure\", input validation errors occurred. Please refer to the \"Errors Section\" for more info.")
