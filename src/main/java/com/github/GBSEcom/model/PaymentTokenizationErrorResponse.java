...
import com.github.GBSEcom.model.AdditionalResponseData;
...
public class PaymentTokenizationErrorResponse {
  ...
  public static final String SERIALIZED_NAME_ADDITIONAL_RESPONSE_DATA = "additionalResponseData";
  @SerializedName(SERIALIZED_NAME_ADDITIONAL_RESPONSE_DATA)
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "R-44df6542-ae0b-4415-88e8-7f3e62cc9e5d", value = "Note - Client Order ID if supplied by client. If not supplied by client, IPG will generate. The first 12 alphanumeric digits are passed down to Fiserv Enterprise reporting tool, Clientline and Data File Manager (DFM).")
  ...
  public PaymentTokenizationErrorResponse ipgTransactionId(String ipgTransactionId) {
  ...
  **/
  ...
  public PaymentTokenizationErrorResponse merchantTransactionId(String merchantTransactionId) {
  ...
  **/
  ...
  public PaymentTokenizationErrorResponse additionalResponseData(AdditionalResponseData additionalResponseData) {
  ...
  **/
  ...
  public void setAdditionalResponseData(AdditionalResponseData additionalResponseData) {
    this.additionalResponseData = additionalResponseData;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.clientRequestId, paymentTokenizationErrorResponse.clientRequestId) &&
        ...
        Objects.equals(this.ipgTransactionId, paymentTokenizationErrorResponse.ipgTransactionId) &&
        Objects.equals(this.merchantTransactionId, paymentTokenizationErrorResponse.merchantTransactionId) &&
        Objects.equals(this.additionalResponseData, paymentTokenizationErrorResponse.additionalResponseData) &&
        Objects.equals(this.error, paymentTokenizationErrorResponse.error);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientRequestId, apiTraceId, responseType, requestStatus, requestTime, brand, country, paymentToken, paymentCard, processor, orderId, ipgTransactionId, merchantTransactionId, additionalResponseData, error);
  }
  ...
  public String toString() {
    ...
    sb.append("    additionalResponseData: ").append(toIndentedString(additionalResponseData)).append("\n");
