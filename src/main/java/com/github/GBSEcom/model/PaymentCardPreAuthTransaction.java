...
public class PaymentCardPreAuthTransaction extends PrimaryTransaction {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(paymentMethod, storedCredentials, createToken, splitShipment, settlementSplit, authenticationRequest, authenticationResult, super.hashCode());
  }
