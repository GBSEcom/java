...
public class PurchaseCardsLevel2 {
  ...
  **/
  @ApiModelProperty(value = "Customer Code/Customer Reference ID")
  ...
  **/
  @ApiModelProperty(value = "Purchase Identifier/Merchant related data")
  ...
  **/
  @ApiModelProperty(value = "Merchant VAT registration/Single Business Reference Number/Merchant Tax ID or Corporation VAT Number")
