...
public interface PaymentApi {
	TransactionResponse finalizeSecureTransaction(String transactionId, AuthenticationUpdateRequest payload, String region);
	TransactionResponse finalizeSecureTransaction(String transactionId, AuthenticationUpdateRequest payload);
...
class PaymentApiImpl extends ApiWrapper<com.github.GBSEcom.api.PaymentApi> implements PaymentApi {
	...
	public TransactionResponse finalizeSecureTransaction(final String transactionId, final AuthenticationUpdateRequest payload, final String region) throws ApiException {
	...
	public TransactionResponse finalizeSecureTransaction(final String transactionId, final AuthenticationUpdateRequest payload) throws ApiException {
