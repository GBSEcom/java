...
public class AuthenticationApi {
    ...
    private com.squareup.okhttp.Call authenticationAccessTokensPostValidateBeforeCall(String contentType, String clientRequestId, String apiKey, Long timestamp, String messageSignature, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = authenticationAccessTokensPostCall(contentType, clientRequestId, apiKey, timestamp, messageSignature, progressListener, progressRequestListener);
        return call;
     ...
     */
    public AccessTokenResponse authenticationAccessTokensPost(String contentType, String clientRequestId, String apiKey, Long timestamp, String messageSignature) throws ApiException {
        ApiResponse<AccessTokenResponse> resp = authenticationAccessTokensPostWithHttpInfo(contentType, clientRequestId, apiKey, timestamp, messageSignature);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AccessTokenResponse> authenticationAccessTokensPostWithHttpInfo(String contentType, String clientRequestId, String apiKey, Long timestamp, String messageSignature) throws ApiException {
        com.squareup.okhttp.Call call = authenticationAccessTokensPostValidateBeforeCall(contentType, clientRequestId, apiKey, timestamp, messageSignature, null, null);
     ...
     */
    public com.squareup.okhttp.Call authenticationAccessTokensPostAsync(String contentType, String clientRequestId, String apiKey, Long timestamp, String messageSignature, final ApiCallback<AccessTokenResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = authenticationAccessTokensPostValidateBeforeCall(contentType, clientRequestId, apiKey, timestamp, messageSignature, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AccessTokenResponse>(){}.getType();
