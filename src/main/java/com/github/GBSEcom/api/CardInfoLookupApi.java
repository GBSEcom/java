...
public class CardInfoLookupApi {
    private ApiClient apiClient;

    public CardInfoLookupApi() {
        this(Configuration.getDefaultApiClient());
    }

    public CardInfoLookupApi(ApiClient apiClient) {
     ...
     * @param cardInfoLookupRequest Card information lookup payload. (required)
    ...
    public com.squareup.okhttp.Call cardInfoLookupCall(String contentType, String clientRequestId, String apiKey, Long timestamp, CardInfoLookupRequest cardInfoLookupRequest, String messageSignature, String region, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/v1/card-information";
