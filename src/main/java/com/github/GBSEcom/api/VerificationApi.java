...
public class VerificationApi {
    ...
    private com.squareup.okhttp.Call verifyAccountValidateBeforeCall(String contentType, String clientRequestId, String apiKey, Long timestamp, AccountVerificationRequest accountVerificationRequest, String messageSignature, String region, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = verifyAccountCall(contentType, clientRequestId, apiKey, timestamp, accountVerificationRequest, messageSignature, region, progressListener, progressRequestListener);
        return call;
    ...
    public TransactionResponse verifyAccount(String contentType, String clientRequestId, String apiKey, Long timestamp, AccountVerificationRequest accountVerificationRequest, String messageSignature, String region) throws ApiException {
        ApiResponse<TransactionResponse> resp = verifyAccountWithHttpInfo(contentType, clientRequestId, apiKey, timestamp, accountVerificationRequest, messageSignature, region);
        return resp.getData();
    }
    ...
    public ApiResponse<TransactionResponse> verifyAccountWithHttpInfo(String contentType, String clientRequestId, String apiKey, Long timestamp, AccountVerificationRequest accountVerificationRequest, String messageSignature, String region) throws ApiException {
        com.squareup.okhttp.Call call = verifyAccountValidateBeforeCall(contentType, clientRequestId, apiKey, timestamp, accountVerificationRequest, messageSignature, region, null, null);
     ...
     */
    public com.squareup.okhttp.Call verifyAccountAsync(String contentType, String clientRequestId, String apiKey, Long timestamp, AccountVerificationRequest accountVerificationRequest, String messageSignature, String region, final ApiCallback<TransactionResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = verifyAccountValidateBeforeCall(contentType, clientRequestId, apiKey, timestamp, accountVerificationRequest, messageSignature, region, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TransactionResponse>(){}.getType();
