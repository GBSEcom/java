...
public class InformationLookupApi {
     ...
     */
    public com.squareup.okhttp.Call cardInfoLookupCall(String contentType, String clientRequestId, String apiKey, Long timestamp, CardInfoLookupRequest cardInfoLookupRequest, String messageSignature, String region, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call cardInfoLookupValidateBeforeCall(String contentType, String clientRequestId, String apiKey, Long timestamp, CardInfoLookupRequest cardInfoLookupRequest, String messageSignature, String region, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = cardInfoLookupCall(contentType, clientRequestId, apiKey, timestamp, cardInfoLookupRequest, messageSignature, region, progressListener, progressRequestListener);
        return call;
    ...
    public CardInfoLookupResponse cardInfoLookup(String contentType, String clientRequestId, String apiKey, Long timestamp, CardInfoLookupRequest cardInfoLookupRequest, String messageSignature, String region) throws ApiException {
        ApiResponse<CardInfoLookupResponse> resp = cardInfoLookupWithHttpInfo(contentType, clientRequestId, apiKey, timestamp, cardInfoLookupRequest, messageSignature, region);
        return resp.getData();
    }
    ...
    public ApiResponse<CardInfoLookupResponse> cardInfoLookupWithHttpInfo(String contentType, String clientRequestId, String apiKey, Long timestamp, CardInfoLookupRequest cardInfoLookupRequest, String messageSignature, String region) throws ApiException {
        com.squareup.okhttp.Call call = cardInfoLookupValidateBeforeCall(contentType, clientRequestId, apiKey, timestamp, cardInfoLookupRequest, messageSignature, region, null, null);
     ...
     */
    public com.squareup.okhttp.Call cardInfoLookupAsync(String contentType, String clientRequestId, String apiKey, Long timestamp, CardInfoLookupRequest cardInfoLookupRequest, String messageSignature, String region, final ApiCallback<CardInfoLookupResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = cardInfoLookupValidateBeforeCall(contentType, clientRequestId, apiKey, timestamp, cardInfoLookupRequest, messageSignature, region, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CardInfoLookupResponse>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call lookupAccountCall(String contentType, String clientRequestId, String apiKey, Long timestamp, AccountInfoLookupRequest accountInfoLookupRequest, String messageSignature, String region, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call lookupAccountValidateBeforeCall(String contentType, String clientRequestId, String apiKey, Long timestamp, AccountInfoLookupRequest accountInfoLookupRequest, String messageSignature, String region, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = lookupAccountCall(contentType, clientRequestId, apiKey, timestamp, accountInfoLookupRequest, messageSignature, region, progressListener, progressRequestListener);
        return call;
    ...
    public CardInfoLookupResponse lookupAccount(String contentType, String clientRequestId, String apiKey, Long timestamp, AccountInfoLookupRequest accountInfoLookupRequest, String messageSignature, String region) throws ApiException {
        ApiResponse<CardInfoLookupResponse> resp = lookupAccountWithHttpInfo(contentType, clientRequestId, apiKey, timestamp, accountInfoLookupRequest, messageSignature, region);
        return resp.getData();
    }
    ...
    public ApiResponse<CardInfoLookupResponse> lookupAccountWithHttpInfo(String contentType, String clientRequestId, String apiKey, Long timestamp, AccountInfoLookupRequest accountInfoLookupRequest, String messageSignature, String region) throws ApiException {
        com.squareup.okhttp.Call call = lookupAccountValidateBeforeCall(contentType, clientRequestId, apiKey, timestamp, accountInfoLookupRequest, messageSignature, region, null, null);
        Type localVarReturnType = new TypeToken<CardInfoLookupResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call lookupAccountAsync(String contentType, String clientRequestId, String apiKey, Long timestamp, AccountInfoLookupRequest accountInfoLookupRequest, String messageSignature, String region, final ApiCallback<CardInfoLookupResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = lookupAccountValidateBeforeCall(contentType, clientRequestId, apiKey, timestamp, accountInfoLookupRequest, messageSignature, region, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CardInfoLookupResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
