...
public class PaymentTokenApi {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updatePaymentTokenValidateBeforeCall(String contentType, String clientRequestId, String apiKey, Long timestamp, PaymentCardPaymentTokenUpdateRequest paymentCardPaymentTokenUpdateRequest, String messageSignature, String authorization, String region, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updatePaymentTokenCall(contentType, clientRequestId, apiKey, timestamp, paymentCardPaymentTokenUpdateRequest, messageSignature, authorization, region, progressListener, progressRequestListener);
        return call;
    ...
    public PaymentTokenUpdateResponse updatePaymentToken(String contentType, String clientRequestId, String apiKey, Long timestamp, PaymentCardPaymentTokenUpdateRequest paymentCardPaymentTokenUpdateRequest, String messageSignature, String authorization, String region) throws ApiException {
        ApiResponse<PaymentTokenUpdateResponse> resp = updatePaymentTokenWithHttpInfo(contentType, clientRequestId, apiKey, timestamp, paymentCardPaymentTokenUpdateRequest, messageSignature, authorization, region);
        return resp.getData();
    }
    ...
    public ApiResponse<PaymentTokenUpdateResponse> updatePaymentTokenWithHttpInfo(String contentType, String clientRequestId, String apiKey, Long timestamp, PaymentCardPaymentTokenUpdateRequest paymentCardPaymentTokenUpdateRequest, String messageSignature, String authorization, String region) throws ApiException {
        com.squareup.okhttp.Call call = updatePaymentTokenValidateBeforeCall(contentType, clientRequestId, apiKey, timestamp, paymentCardPaymentTokenUpdateRequest, messageSignature, authorization, region, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updatePaymentTokenAsync(String contentType, String clientRequestId, String apiKey, Long timestamp, PaymentCardPaymentTokenUpdateRequest paymentCardPaymentTokenUpdateRequest, String messageSignature, String authorization, String region, final ApiCallback<PaymentTokenUpdateResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updatePaymentTokenValidateBeforeCall(contentType, clientRequestId, apiKey, timestamp, paymentCardPaymentTokenUpdateRequest, messageSignature, authorization, region, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PaymentTokenUpdateResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
