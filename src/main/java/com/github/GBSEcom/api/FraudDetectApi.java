...
public class FraudDetectApi {
     ...
     */
    public com.squareup.okhttp.Call fraudClientRegistrationPostCall(String contentType, String clientRequestId, String apiKey, Long timestamp, ClientRegistration clientRegistration, String messageSignature, String region, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call fraudClientRegistrationPostValidateBeforeCall(String contentType, String clientRequestId, String apiKey, Long timestamp, ClientRegistration clientRegistration, String messageSignature, String region, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = fraudClientRegistrationPostCall(contentType, clientRequestId, apiKey, timestamp, clientRegistration, messageSignature, region, progressListener, progressRequestListener);
        return call;
    ...
    public FraudRegistrationResponse fraudClientRegistrationPost(String contentType, String clientRequestId, String apiKey, Long timestamp, ClientRegistration clientRegistration, String messageSignature, String region) throws ApiException {
        ApiResponse<FraudRegistrationResponse> resp = fraudClientRegistrationPostWithHttpInfo(contentType, clientRequestId, apiKey, timestamp, clientRegistration, messageSignature, region);
        return resp.getData();
    }
    ...
    public ApiResponse<FraudRegistrationResponse> fraudClientRegistrationPostWithHttpInfo(String contentType, String clientRequestId, String apiKey, Long timestamp, ClientRegistration clientRegistration, String messageSignature, String region) throws ApiException {
        com.squareup.okhttp.Call call = fraudClientRegistrationPostValidateBeforeCall(contentType, clientRequestId, apiKey, timestamp, clientRegistration, messageSignature, region, null, null);
     ...
     */
    public com.squareup.okhttp.Call fraudClientRegistrationPostAsync(String contentType, String clientRequestId, String apiKey, Long timestamp, ClientRegistration clientRegistration, String messageSignature, String region, final ApiCallback<FraudRegistrationResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = fraudClientRegistrationPostValidateBeforeCall(contentType, clientRequestId, apiKey, timestamp, clientRegistration, messageSignature, region, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<FraudRegistrationResponse>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call fraudPaymentRegistrationPostCall(String contentType, String clientRequestId, String apiKey, Long timestamp, PaymentRegistration paymentRegistration, String messageSignature, String region, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call fraudPaymentRegistrationPostValidateBeforeCall(String contentType, String clientRequestId, String apiKey, Long timestamp, PaymentRegistration paymentRegistration, String messageSignature, String region, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = fraudPaymentRegistrationPostCall(contentType, clientRequestId, apiKey, timestamp, paymentRegistration, messageSignature, region, progressListener, progressRequestListener);
        return call;
    ...
    public FraudRegistrationResponse fraudPaymentRegistrationPost(String contentType, String clientRequestId, String apiKey, Long timestamp, PaymentRegistration paymentRegistration, String messageSignature, String region) throws ApiException {
        ApiResponse<FraudRegistrationResponse> resp = fraudPaymentRegistrationPostWithHttpInfo(contentType, clientRequestId, apiKey, timestamp, paymentRegistration, messageSignature, region);
        return resp.getData();
    }
    ...
    public ApiResponse<FraudRegistrationResponse> fraudPaymentRegistrationPostWithHttpInfo(String contentType, String clientRequestId, String apiKey, Long timestamp, PaymentRegistration paymentRegistration, String messageSignature, String region) throws ApiException {
        com.squareup.okhttp.Call call = fraudPaymentRegistrationPostValidateBeforeCall(contentType, clientRequestId, apiKey, timestamp, paymentRegistration, messageSignature, region, null, null);
        Type localVarReturnType = new TypeToken<FraudRegistrationResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call fraudPaymentRegistrationPostAsync(String contentType, String clientRequestId, String apiKey, Long timestamp, PaymentRegistration paymentRegistration, String messageSignature, String region, final ApiCallback<FraudRegistrationResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = fraudPaymentRegistrationPostValidateBeforeCall(contentType, clientRequestId, apiKey, timestamp, paymentRegistration, messageSignature, region, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<FraudRegistrationResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
