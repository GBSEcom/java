...
public class PaymentSchedulesApi {
    ...
    public com.squareup.okhttp.Call cancelPaymentScheduleCall(String contentType, String clientRequestId, String apiKey, Long timestamp, String orderId, String messageSignature, String region, String storeId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/v1/payment-schedules/{order-id}"
     ...
     * @param apiKey  (required)
     * @param timestamp Epoch timestamp in milliseconds in the request from a client system. Used for Message Signature generation and time limit (5 mins). (required)
     * @param paymentSchedulesRequest  (required)
     * @param messageSignature Used to ensure the request has not been tampered with during transmission. The Message-Signature is the Base64 encoded HMAC hash (SHA256  algorithm with the API Secret as the key.) For more information, refer to the supporting documentation on the Developer Portal. (optional)
     * @param region The region where client wants to process the transaction (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
    ...
    /**
     * Use this to create a gateway payment schedule. (asynchronously)
     * This can be used to create a gateway payment schedule.
     * @param contentType content type (required)
     * @param clientRequestId A client-generated ID for request tracking and signature creation, unique per request.  This is also used for idempotency control. We recommend 128-bit UUID format. (required)
     * @param apiKey  (required)
    ...
    private com.squareup.okhttp.Call updatePaymentScheduleValidateBeforeCall(String contentType, String clientRequestId, String apiKey, Long timestamp, String orderId, PaymentSchedulesRequest paymentSchedulesRequest, String messageSignature, String region, String storeId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updatePaymentScheduleCall(contentType, clientRequestId, apiKey, timestamp, orderId, paymentSchedulesRequest, messageSignature, region, storeId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PaymentSchedulesResponse updatePaymentSchedule(String contentType, String clientRequestId, String apiKey, Long timestamp, String orderId, PaymentSchedulesRequest paymentSchedulesRequest, String messageSignature, String region, String storeId) throws ApiException {
        ApiResponse<PaymentSchedulesResponse> resp = updatePaymentScheduleWithHttpInfo(contentType, clientRequestId, apiKey, timestamp, orderId, paymentSchedulesRequest, messageSignature, region, storeId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PaymentSchedulesResponse> updatePaymentScheduleWithHttpInfo(String contentType, String clientRequestId, String apiKey, Long timestamp, String orderId, PaymentSchedulesRequest paymentSchedulesRequest, String messageSignature, String region, String storeId) throws ApiException {
        com.squareup.okhttp.Call call = updatePaymentScheduleValidateBeforeCall(contentType, clientRequestId, apiKey, timestamp, orderId, paymentSchedulesRequest, messageSignature, region, storeId, null, null);
        Type localVarReturnType = new TypeToken<PaymentSchedulesResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public com.squareup.okhttp.Call updatePaymentScheduleAsync(String contentType, String clientRequestId, String apiKey, Long timestamp, String orderId, PaymentSchedulesRequest paymentSchedulesRequest, String messageSignature, String region, String storeId, final ApiCallback<PaymentSchedulesResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updatePaymentScheduleValidateBeforeCall(contentType, clientRequestId, apiKey, timestamp, orderId, paymentSchedulesRequest, messageSignature, region, storeId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PaymentSchedulesResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
