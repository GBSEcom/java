...
public class PaymentUrlApi {
     ...
     * @param transactionId Gateway transaction identifier as returned in the parameter ipgTransactionId. (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deletePaymentUrlCall(String contentType, String clientRequestId, String apiKey, Long timestamp, String messageSignature, String region, String storeId, String transactionId, String orderId, String paymentUrlId, String transactionTime, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (paymentUrlId != null) {
            localVarQueryParams.addAll(apiClient.parameterToPair("paymentUrlId", paymentUrlId));
        }

        if (transactionTime != null) {
            localVarQueryParams.addAll(apiClient.parameterToPair("transactionTime", transactionTime));
        }
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deletePaymentUrlValidateBeforeCall(String contentType, String clientRequestId, String apiKey, Long timestamp, String messageSignature, String region, String storeId, String transactionId, String orderId, String paymentUrlId, String transactionTime, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deletePaymentUrlCall(contentType, clientRequestId, apiKey, timestamp, messageSignature, region, storeId, transactionId, orderId, paymentUrlId, transactionTime, progressListener, progressRequestListener);
        return call;
    ...
    public PaymentUrlResponse deletePaymentUrl(String contentType, String clientRequestId, String apiKey, Long timestamp, String messageSignature, String region, String storeId, String transactionId, String orderId, String paymentUrlId, String transactionTime) throws ApiException {
        ApiResponse<PaymentUrlResponse> resp = deletePaymentUrlWithHttpInfo(contentType, clientRequestId, apiKey, timestamp, messageSignature, region, storeId, transactionId, orderId, paymentUrlId, transactionTime);
        return resp.getData();
    }
    ...
    public ApiResponse<PaymentUrlResponse> deletePaymentUrlWithHttpInfo(String contentType, String clientRequestId, String apiKey, Long timestamp, String messageSignature, String region, String storeId, String transactionId, String orderId, String paymentUrlId, String transactionTime) throws ApiException {
        com.squareup.okhttp.Call call = deletePaymentUrlValidateBeforeCall(contentType, clientRequestId, apiKey, timestamp, messageSignature, region, storeId, transactionId, orderId, paymentUrlId, transactionTime, null, null);
        Type localVarReturnType = new TypeToken<PaymentUrlResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deletePaymentUrlAsync(String contentType, String clientRequestId, String apiKey, Long timestamp, String messageSignature, String region, String storeId, String transactionId, String orderId, String paymentUrlId, String transactionTime, final ApiCallback<PaymentUrlResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deletePaymentUrlValidateBeforeCall(contentType, clientRequestId, apiKey, timestamp, messageSignature, region, storeId, transactionId, orderId, paymentUrlId, transactionTime, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PaymentUrlResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call paymentUrlDetailCall(String contentType, String clientRequestId, String apiKey, Long timestamp, String fromDate, String toDate, String messageSignature, String region, String storeId, String orderId, String merchantTransactionId, String status, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = new Object();
        ...
        if (merchantTransactionId != null) {
            localVarQueryParams.addAll(apiClient.parameterToPair("merchantTransactionId", merchantTransactionId));
        }
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call paymentUrlDetailValidateBeforeCall(String contentType, String clientRequestId, String apiKey, Long timestamp, String fromDate, String toDate, String messageSignature, String region, String storeId, String orderId, String merchantTransactionId, String status, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = paymentUrlDetailCall(contentType, clientRequestId, apiKey, timestamp, fromDate, toDate, messageSignature, region, storeId, orderId, merchantTransactionId, status, progressListener, progressRequestListener);
        return call;
    ...
    public PaymentUrlDetailResponse paymentUrlDetail(String contentType, String clientRequestId, String apiKey, Long timestamp, String fromDate, String toDate, String messageSignature, String region, String storeId, String orderId, String merchantTransactionId, String status) throws ApiException {
        ApiResponse<PaymentUrlDetailResponse> resp = paymentUrlDetailWithHttpInfo(contentType, clientRequestId, apiKey, timestamp, fromDate, toDate, messageSignature, region, storeId, orderId, merchantTransactionId, status);
        return resp.getData();
    }
    ...
    public ApiResponse<PaymentUrlDetailResponse> paymentUrlDetailWithHttpInfo(String contentType, String clientRequestId, String apiKey, Long timestamp, String fromDate, String toDate, String messageSignature, String region, String storeId, String orderId, String merchantTransactionId, String status) throws ApiException {
        com.squareup.okhttp.Call call = paymentUrlDetailValidateBeforeCall(contentType, clientRequestId, apiKey, timestamp, fromDate, toDate, messageSignature, region, storeId, orderId, merchantTransactionId, status, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call paymentUrlDetailAsync(String contentType, String clientRequestId, String apiKey, Long timestamp, String fromDate, String toDate, String messageSignature, String region, String storeId, String orderId, String merchantTransactionId, String status, final ApiCallback<PaymentUrlDetailResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = paymentUrlDetailValidateBeforeCall(contentType, clientRequestId, apiKey, timestamp, fromDate, toDate, messageSignature, region, storeId, orderId, merchantTransactionId, status, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PaymentUrlDetailResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
