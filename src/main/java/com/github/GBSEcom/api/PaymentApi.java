...
public class PaymentApi {
     ...
     * @param authenticationUpdateRequest Accepted request types: Secure3D10AuthenticationUpdateRequest, Secure3D21AuthenticationUpdateRequest, and UnionPayAuthenticationUpdateRequest. (required)
    ...
    private com.squareup.okhttp.Call finalizeSecureTransactionValidateBeforeCall(String contentType, String clientRequestId, String apiKey, Long timestamp, String transactionId, AuthenticationUpdateRequest authenticationUpdateRequest, String messageSignature, String region, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = finalizeSecureTransactionCall(contentType, clientRequestId, apiKey, timestamp, transactionId, authenticationUpdateRequest, messageSignature, region, progressListener, progressRequestListener);
        return call;
    ...
    public TransactionResponse finalizeSecureTransaction(String contentType, String clientRequestId, String apiKey, Long timestamp, String transactionId, AuthenticationUpdateRequest authenticationUpdateRequest, String messageSignature, String region) throws ApiException {
        ApiResponse<TransactionResponse> resp = finalizeSecureTransactionWithHttpInfo(contentType, clientRequestId, apiKey, timestamp, transactionId, authenticationUpdateRequest, messageSignature, region);
        return resp.getData();
    }
    ...
    public ApiResponse<TransactionResponse> finalizeSecureTransactionWithHttpInfo(String contentType, String clientRequestId, String apiKey, Long timestamp, String transactionId, AuthenticationUpdateRequest authenticationUpdateRequest, String messageSignature, String region) throws ApiException {
        com.squareup.okhttp.Call call = finalizeSecureTransactionValidateBeforeCall(contentType, clientRequestId, apiKey, timestamp, transactionId, authenticationUpdateRequest, messageSignature, region, null, null);
    ...
    public com.squareup.okhttp.Call finalizeSecureTransactionAsync(String contentType, String clientRequestId, String apiKey, Long timestamp, String transactionId, AuthenticationUpdateRequest authenticationUpdateRequest, String messageSignature, String region, final ApiCallback<TransactionResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = finalizeSecureTransactionValidateBeforeCall(contentType, clientRequestId, apiKey, timestamp, transactionId, authenticationUpdateRequest, messageSignature, region, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TransactionResponse>(){}.getType();
     ...
     * @param timestamp Epoch timestamp in milliseconds in the request from a client system. Used for Message Signature generation and time limit (5 mins). (required)
     * @param transactionId Gateway transaction identifier as returned in the parameter ipgTransactionId or merchantTransactionId. (required)
     * @param secondaryTransaction Accepted request types: PostAuthTransaction, VoidTransaction, VoidPreAuthTransactions, ReturnTransaction, AchPostAuthTransaction, AchVoidTransaction and AchReturnTransaction. (required)
     * @param messageSignature Used to ensure the request has not been tampered with during transmission. The Message-Signature is the Base64 encoded HMAC hash (SHA256 algorithm with the API Secret as the key.) For more information, refer to the supporting documentation on the Developer Portal. (optional)
     * @param region Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing. (optional)
