...
public class SepaMandate {
    ...
    /**
     * Sequence type of the mandate, defaults to &#39;SINGLE&#39; if not provided.
     */
    ...
    /**
     * Existing mandate reference managed by a merchant. Also known as the Mandate ID.
     *
     * @return reference
     **/
    @ApiModelProperty(value = "Existing mandate reference managed by a merchant. Also known as the Mandate ID.")
     ...
     * @return url
     **/
    @ApiModelProperty(value = "Valid URL pointing to the SEPA mandate (PDF / HTML format recommended)")
     ...
     * @return type
     **/
    @ApiModelProperty(value = "Sequence type of the mandate, defaults to 'SINGLE' if not provided.")
