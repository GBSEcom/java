...
public class PaymentApiTest {
    ...
    public void finalizeSecureTransactionTest() throws ApiException {
        ...
        String region = null;
        TransactionResponse response = api.finalizeSecureTransaction(contentType, clientRequestId, apiKey, timestamp, transactionId, authenticationVerificationRequest, messageSignature, region);
